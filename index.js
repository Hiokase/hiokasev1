...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["5569999662600@s.whatsapp.net"] // replace this with your number
			...
			switch(command) {
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* Hokase\n*https://www.youtube.com/channel/UCfTeLfKieKBmZQs6S9y8q7Q:* https://bit.ly/2MD43V2\n*WPP:* wa.me/+5517991134416\n*INSTA:* to sem aff kk\n\n\n*Digite *.bot* para ver comandos basicos para criar um bot'})
					break
				case 'belle2':
					memein = await kagApi.memeindo()
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do Hokase:*\n\n https://www.https://www.youtube.com/channel/UCfTeLfKieKBmZQs6S9y8q7Q.com/channel/UCfTeLfKieKBmZQs6S9y8q7Q'})
					break
				case 'mia1':
					memein = await kagApi.memeindo()
