...
║ Prefix para usar os Cmds:  *${prefix} *
║ Status do bot: *「 Desenvolvimento 」*

 
   *sisτємα ∂є ƒigυrαs*
      
║ Cmd : *${prefix}sticker* ou *${prefix}stiker*
║ útil em : converter imagem/gif/vídeo em adesivo\n

║ Cmd : *${prefix}sticker nobg* ou *${prefix}stiker nobg*
║ útil em : converter imagem em adesivo removendo o fundo\n
║ Cmd : *${prefix}toimg*
║ útil em : converter adesivo em imagem\n
║ Cmd : *${prefix}tsticker* ou *${prefix}tstiker*
